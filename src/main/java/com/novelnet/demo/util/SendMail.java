...
public class SendMail {
    ...
    public static String mailboxVerification(String email) throws MessagingException {
        ...
        //连接服务器
        transport.connect("smtp.qq.com", "2030005280@qq.com", "bjfjzjgsurbyebci");
        //创建邮件对象
        MimeMessage mimeMessage = new MimeMessage(session);
        //设置发件人地址
        mimeMessage.setFrom(new InternetAddress("2030005280@qq.com"));
        //设置收件人地址（单发
        ...
        //设置邮件标题
        mimeMessage.setSubject("盗圣小说邮箱验证码通知");
        //生成验证码
        ...
        String emailContent = "【盗圣小说】 验证码 " + verificationCode + "。感谢使用盗圣小说。";
        //设置邮件内容
